...
<section class>
  <div class="box" style="background-color: #f5f5f5; border-left: 4px solid #3273dc; padding: 10px; font-size: 0.5rem; margin-left: 0;">
      ...
      <p>A VLA model learns visuomotor policies directly from language supervision</p>
  </div>
</section>
...
<section class>
  <div class="box" style="background-color: #f5f5f5; border-left: 4px solid #3273dc; padding: 10px; font-size: 0.5rem; margin-left: 0;">
      <p>1. Provide initial **language instruction** (e.g., “Pour the dog food”)</p>
      <p>2. Provide **natural language supervisions** in each state to complete the instruction (e.g., “Move left”)</p>
...
<section class>
  <div class="box" style="background-color: #f5f5f5; border-left: 4px solid #3273dc; padding: 10px; font-size: 0.5rem; margin-left: 0;">
      <p>CLIP-RT outperforms OpenVLA in average success rates by **3% on common tasks and 24% on novel tasks**.</p>
      <p>**Natural language supervision** significantly increases performance (vs CLIP-RT-Action)</p>
      <p>**STD** boosts the overall performance (vs CLIP-RT-Passive)</p>
  </div>
</section>
