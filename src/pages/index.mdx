...
import figure1 from "../assets/01_teaser.png";
...
<Header
  ...
  institute={[
    { symbol: "1", name: "Seoul National University", logo:"src/assets/logo_snu.png"},
    { symbol: "2", name: "Tommoro Robotics", logo:"src/assets/logo_tommoro.png" },
  ]}
  conference="RSS 2025"
  links={[
    {
    ...
    {
      name: "Code",
      url: "https://github.com/clip-rt/clip-rt",
      icon: "mdi:github",
    },
    {
      name: "Models",
      url: "https://huggingface.co/clip-rt",
      iconComponent: `<img src="https://raw.githubusercontent.com/clip-rt/clip-rt.github.io/refs/heads/main/src/assets/huggingface.svg" alt="Huggingface" width="24" style="vertical-align: middle;" />`,
    }
...
<section class="my-6">
  <div class="border-l-4 border-blue-500 bg-zinc-50 p-5 rounded-md shadow-sm">
    <p class="font-bold text-zinc-800 mb-2">TL;DR</p>
    <p class="text-zinc-700">
      Robotic data collection through natural language supervision
    </p>
    <p class="text-zinc-700">
      VLA model that learns visuomotor skills directly from natural language 
    </p>
  </div>
</section>
...
<Figure
    caption="Overview of language-guided teleoperation.">
...
<Figure
    ...
    <Image source={exp_results2} altText="Comparison between multi-task and single-task policies."/>
</Figure>
...
<section class>
  <div class="box" style="background-color: #f5f5f5; border-left: 4px solid #3273dc; padding: 10px; font-size: 0.5rem; margin-left: 0;">
      <p>**Generality**: Is CLIP-RT applicable to environments with offline, human-teleoperated demonstrations?</p>
      <p>**Performance**: Does CLIP-RT remain effective in a controlled simulation setting?</p>
  </div>
</section>
...
<Figure
    caption="LIBERO task performance and inference efficiency results.">
    <Image source={libero} altText="LIBERO task performance and inference efficiency results."/>
</Figure>
