...
<section class>
  <div class="box" style="background-color: #f5f5f5; border-left: 4px solid #3273dc; padding: 10px; font-size: 0.5rem; margin-left: 0;">
      ...
      <p>A VLA model that learns language-conditioned visuomotor skills directly from language supervision</p>
  </div>
</section>
...
<section class>
  <div class="box" style="background-color: #f5f5f5; border-left: 4px solid #3273dc; padding: 10px; font-size: 0.5rem; margin-left: 0;">
      ...
      <p>1. CLIP-RT outperforms OpenVLA in average success rates by **3% (Common tasks) and 24% (Novel tasks)**.</p>
