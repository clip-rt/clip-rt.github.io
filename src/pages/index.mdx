...
(1) Collect robotic data through natural language supervision
(2) A VLA model learns visuomotor policies directly from language supervision
...
(1) CLIP-RT outperforms OpenVLA in average success rates by **3% on common tasks and 24% on novel manipulation tasks**.
