...
<Header
  ...
  institute={[
    { symbol: "1", name: "Seoul National University" },
    { symbol: "2", name: "Tommoro Robotics" },
  ]}
...
<Figure
    caption="Comparison between multi-task and single-task policies" className="figure-small">
